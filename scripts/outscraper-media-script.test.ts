...
assert.match(scriptSource, /buildListingDataOutputs/, "script should regenerate every publication-filtered derived listing file");
assert.match(scriptSource, /readListingPublicationRegistry/, "script should preserve publication eligibility while updating media");
