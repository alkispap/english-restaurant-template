...
assert.ok(
  ...
  "canonical restaurant detail URLs should use /restaurants/"
);
assert.ok(
  !urls.some((url) => url.includes("/listings/")),
  "legacy /listings/ detail URLs should not be listed in the sitemap"
);
