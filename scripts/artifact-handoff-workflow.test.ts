...
assert.match(source, /downloaded-candidate\\out/, "verification must use the flattened artifact root created by the upload action");
assert.match(source, /downloaded-candidate\\evidence/, "verification must use the flattened evidence root created by the upload action");
