...
- The pull-request review follow-up now rejects evidence directories whose child names merely begin with two dots (for example, `..candidate`); the focused artifact tests and a fresh 169/169 Linux suite passed after that correction.
